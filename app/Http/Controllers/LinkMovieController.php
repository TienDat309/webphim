...
class LinkMovieController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data  = $request->validate(
            ...
            [
                'title.unique'=>'Tên link đã có. Xin nhập tên khác.',
                'title.required'=>'Tên link không được trống.',
                'description.required'=>'Mô tả link không được trống.',
            ]
        );
    ...
    public function update(Request $request, $id)
    {
        ...
        $linkmovie->status = $data['status'];
        $linkmovie->save();
        toastr()->success('Cập nhật link phim thành công.');
        return redirect()->route('linkmovie.index');
    }
    ...
    public function destroy($id)
    {
        ...
        toastr()->success('Xóa link phim thành công.');
