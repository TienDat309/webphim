...
class IndexController extends Controller
{
    ...
    public function category($slug){
        ...
        $movie = Movie::where('category_id',$cate_slug->id)->orderBy('updateday', 'DESC')->paginate(20);
    ...
    public function year($year){
        ...
        $phimhot_sidebar = Movie::where('phim_hot',1)->where('status',1)->orderBy('updateday', 'DESC')->take(15)->get();
        $year = $year; 
        $movie = Movie::where('year',$year)->orderBy('updateday', 'DESC')->paginate(20);
    ...
    public function tag($tag){
        ...
        $phimhot_sidebar = Movie::where('phim_hot',1)->where('status',1)->orderBy('updateday', 'DESC')->take(15)->get();
        $tag = $tag; 
        $movie = Movie::where('tags','LIKE','%'.$tag.'%')->orderBy('updateday', 'DESC')->paginate(20);//LIKE lấy gần đúng
